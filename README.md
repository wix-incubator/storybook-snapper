...
The idea is to be  write snapshot tests as `describe/it` test suites like in familiar testing framework. Each test suite creates a `storybook` story, which `eyes-storybook`, in turn, takes a snapshot of.  
